      ...
      <div className="max-w-5xl mx-auto text-center">
        <div className="mb-8 animate-fade-in">
          ...
          <p className="text-2xl md:text-3xl text-primary-foreground/90 mb-6 font-light">
            Aspiring AI-Native Project Manager
          </p>

          <p className="text-lg md:text-xl text-primary-foreground/80 max-w-3xl mx-auto mb-8 leading-relaxed">
            Passionate about the intersection between business and emerging technologies
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-12">
          ...
          <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-lg p-6 border border-primary-foreground/20">
            <div className="flex items-center justify-center mb-2">
              ...
              <span className="text-3xl font-bold text-primary-foreground">PSM I</span>
            </div>
            <p className="text-primary-foreground/80 text-sm">Certified Scrum Master</p>
          </div>
